...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-su65dzm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-su65dzm.containers.anotherwebservice.com/
...
```
git clone git@github.com:kilwapp24/container-su65dzm.git
cd container-su65dzm
```
...
```
docker attach container-su65dzm
```
